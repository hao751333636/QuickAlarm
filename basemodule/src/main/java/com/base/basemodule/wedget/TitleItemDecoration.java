...
public class TitleItemDecoration extends RecyclerView.ItemDecoration {
    ...
    private static int TITLE_BG_COLOR = Color.parseColor("#3f4253");
    private static int TITLE_TEXT_COLOR = Color.parseColor("#FFffff");
    private static int mTitleTextSize;


    public TitleItemDecoration(Context context, List<? extends SortModel> data) {
        super();
        mData = data;
        mPaint = new Paint();
        mBounds = new Rect();
